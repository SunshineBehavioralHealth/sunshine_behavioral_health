...
function my_scripts()
{
	...
	wp_enqueue_script('navigation', get_template_directory_uri() . '/js/dataLayer.js', array('jquery'), '', true);
	wp_enqueue_script('navigation', get_template_directory_uri() . '/js/invocaCookie.js', array('jquery'), '', true);
}
