<section class="learn_centers_sidebar_section">
    <div class="learn_centers_center_container">
        ...
        <a href="/our-rehab-centers/willow-springs-recovery/"><img src="<?php echo get_template_directory_uri() . '/images/sidebar/willow_our_center_sidebar.jpg' ?>" alt="" loading="lazy"></a>

        <a href="/our-rehab-centers/lincoln-recovery/"><img src="<?php echo get_template_directory_uri() . '/images/sidebar/lincoln_our_center_sidebar.jpg' ?>" alt="" loading="lazy"></a>
    </div>
</section>