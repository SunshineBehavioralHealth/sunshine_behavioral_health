<section class="learn_centers_sidebar_section">
    <div class="learn_centers_center_container">
        ...
        <a href="/our-rehab-centers/mountain-springs-recovery/"><img src="<?php echo get_template_directory_uri() . '/images/sidebar/mountains-side-bar.jpg' ?>" alt="" loading="lazy"></a>
