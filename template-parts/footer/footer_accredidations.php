    ...
    <section class="home_footer_accreditations_section">
        <div class="home_footer_accreditations_container">
            <div class="home_footer_accreditations_wrapper">
                <img src="<?php echo get_template_directory_uri() . '/images/sunshine_gold_badge.jpg' ?>" alt="">
                ...
                <img src="<?php echo get_template_directory_uri()  . '/images/austin_texas_badge_150.jpg' ?>" alt="">
                <img src="<?php echo get_template_directory_uri()  . '/images/colorado_springs_badge_150.png' ?>" alt="">
            </div>
