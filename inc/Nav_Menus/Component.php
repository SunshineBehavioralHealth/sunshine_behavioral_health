 ...
 * * `sunshine_behavioral_health()->is_primary_nav_menu_active()`
 * * `sunshine_behavioral_health()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface
{
	...
	public function action_register_nav_menus()
	{
		register_nav_menus(
			[
				static::PRIMARY_NAV_MENU_SLUG => esc_html__('Primary', 'sunshine_behavioral_health'),
			]
		);
	}
