 ...
 * * `sunshine_behavioral_health()->is_primary_sidebar_active()`
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			[
				'name'          => esc_html__( 'Sidebar', 'sunshine_behavioral_health' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'sunshine_behavioral_health' ),
