...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_section(
			'theme_options',
			[
				'title'    => __( 'Theme Options', 'sunshine_behavioral_health' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'sunshine_behavioral_health-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			[ 'customize-preview' ],
			sunshine_behavioral_health()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}
