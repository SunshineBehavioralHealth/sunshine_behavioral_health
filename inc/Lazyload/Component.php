...
class Component implements Component_Interface
{
	...
	public function action_lazyload_images()
	{
		...
		if (sunshine_behavioral_health()->is_amp()) {
			return;
		}
	...
	{
		$lazyload_choices = [
			'lazyload'    => __('Lazy-load on (default)', 'sunshine_behavioral_health'),
			'no-lazyload' => __('Lazy-load off', 'sunshine_behavioral_health'),
		];
		...
		$wp_customize->add_control(
			'lazy_load_media',
			[
				'label'           => __('Lazy-load images', 'sunshine_behavioral_health'),
				'section'         => 'theme_options',
				'type'            => 'radio',
				'description'     => __('Lazy-loading images means images are loaded only when they are in view. Improves performance, but can result in content jumping around on slower connections.', 'sunshine_behavioral_health'),
	...
	{
		wp_script_add_data('sunshine_behavioral_health-lazy-load-images', 'defer', true);
		wp_script_add_data('sunshine_behavioral_health-lazy-load-images', 'precache', true);
	}
