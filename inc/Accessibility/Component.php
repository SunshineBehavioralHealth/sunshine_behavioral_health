...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		// wp_enqueue_script(
		// 	'sunshine_behavioral_health-navigation',
		// 	get_theme_file_uri( '/assets/js/navigation.min.js' ),
		// 	[],
		// 	sunshine_behavioral_health()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
		// 	false
		// );
		wp_script_add_data( 'sunshine_behavioral_health-navigation', 'async', true );
		wp_script_add_data( 'sunshine_behavioral_health-navigation', 'precache', true );
		wp_localize_script(
			'sunshine_behavioral_health-navigation',
			'sunshine_behavioral_healthScreenReaderText',
			[
				'expand'   => __( 'Expand child menu', 'sunshine_behavioral_health' ),
				'collapse' => __( 'Collapse child menu', 'sunshine_behavioral_health' ),
			]
		);
	}
